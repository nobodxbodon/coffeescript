...
(function() {
  ...
  grammar = {
    ...
    ForSource: [
      ...
      }), o('FOR在 Expression WHEN Expression', function() {
        return {
          source: $2,
          guard: $4
        };
      ...
      }), o('FOR在 Expression BY Expression', function() {
        return {
          source: $2,
          step: $4
        };
      ...
      }), o('FOR在 Expression WHEN Expression BY Expression', function() {
        return {
          source: $2,
          guard: $4,
          step: $6
        };
      }), o('FOR在 Expression BY Expression WHEN Expression', function() {
        return {
          source: $2,
          step: $4,
          guard: $6
